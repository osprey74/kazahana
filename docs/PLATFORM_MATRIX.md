...
> **Last updated:** 2026-09-05 (棚卸 — 廃止済みの macOS (Tauri) 列を全表から削除し、macOS は Mac App Store 配信の Catalyst 版へ一本化。各 Claude Code は自リポジトリ担当列のみ更新するルールを明記。Windows 列を v3.6.0 時点へ棚卸)
